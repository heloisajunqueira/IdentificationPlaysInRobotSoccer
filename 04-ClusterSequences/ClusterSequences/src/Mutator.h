...
public:
	...
	Mutator(const vector<int> *, int, int , int minBlockIn = 2);
	Mutator(const vector<int> *, int, int , vector<double> *,int minBlockIn = 2);
	virtual ~Mutator();
	...
	pair<vector<int> *, double> mutateSequence(double);
};
